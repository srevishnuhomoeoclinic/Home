            ...
            var c = a.document,
                ...
                m = function() {
                    var b = k,
                        ...
                        d = 0,
                        e, f, g, i;
                    for (; d < c; d++) e = b[d], f = e.href, g = e.media, i = e.rel && e.rel.toLowerCase() === "stylesheet", !!f && i && !h[f] && (!/^([a-zA-Z]+?:(\/\/)?(www\.)?)/.test(f) || f.replace(RegExp.$1, "").split("http://ppp-templates.de/")[0] === a.location.host ? l.push({
                        href: f,
                        media: g
                    }) : h[f] = !0);
                    n()
                ...
                o = function(a, b, c) {
                    var d = a.match(/@media[^\{]+\{([^\{\}]+\{[^\}\{]+\})+/gi),
                        g = d && d.length || 0,
                        b = b.substring(0, b.lastIndexOf("http://ppp-templates.de/")),
                        h = function(a) {
